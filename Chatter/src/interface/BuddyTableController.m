...
- (void)tableViewSelectionDidChange:(NSNotification *)notification
{
	...
	if (mSelectionTimer == nil)
		mSelectionTimer = [NSTimer scheduledTimerWithTimeInterval:.5 target:self selector:@selector(doSelectionChangedTimer:) userInfo:nil repeats:TRUE];
}
...
- (NSView *)tableView:(NSTableView *)tableView viewForTableColumn:(NSTableColumn *)tableColumn row:(NSInteger)row
{
	...
	if (view == nil) {
		...
		view = [[BuddyView alloc] initWithFrame:NSMakeRect(0., 0., tableFrame.size.width, 38.)];
